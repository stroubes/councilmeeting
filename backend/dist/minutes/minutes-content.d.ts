...
export declare function createDefaultMinutesContent(): MinutesContent;
export declare function normalizeMinutesContent(raw: unknown): MinutesContent;
export declare function ensureMinutesFinalizeReadiness(content: MinutesContent): string[];
