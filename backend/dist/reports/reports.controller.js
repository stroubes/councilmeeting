...
const create_staff_report_dto_1 = require("./dto/create-staff-report.dto");
const create_report_attachment_dto_1 = require("./dto/create-report-attachment.dto");
const import_docx_report_dto_1 = require("./dto/import-docx-report.dto");
const report_query_dto_1 = require("./dto/report-query.dto");
const update_staff_report_dto_1 = require("./dto/update-staff-report.dto");
let ReportsController = class ReportsController {
    ...
    addAttachment(id, dto, user) {
        return this.reportsService.addAttachment(id, dto, user);
    }
    removeAttachment(id, attachmentId, user) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_staff_report_dto_1.CreateStaffReportDto, Object]),
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "create", null);
__decorate([
    (0, permissions_decorator_1.Permissions)(permissions_constants_1.PERMISSIONS.REPORT_SUBMIT),
    (0, common_1.Post)('import-docx'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [import_docx_report_dto_1.ImportDocxReportDto, Object]),
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "importDocx", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_staff_report_dto_1.UpdateStaffReportDto, Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "submitForDirector", null);
__decorate([
    (0, permissions_decorator_1.Permissions)(permissions_constants_1.PERMISSIONS.PUBLIC_PUBLISH),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "listAttachments", null);
__decorate([
    (0, permissions_decorator_1.Permissions)(permissions_constants_1.PERMISSIONS.REPORT_SUBMIT),
    ...
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, create_report_attachment_dto_1.CreateReportAttachmentDto, Object]),
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "addAttachment", null);
__decorate([
    (0, permissions_decorator_1.Permissions)(permissions_constants_1.PERMISSIONS.REPORT_SUBMIT),
    ...
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "removeAttachment", null);
__decorate([
    (0, permissions_decorator_1.Permissions)(permissions_constants_1.PERMISSIONS.REPORT_SUBMIT),
